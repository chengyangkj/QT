...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(459, 675);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        treeWidget_rviz = new QTreeWidget(centralWidget);
        ...
        treeWidget_rviz->setGeometry(QRect(60, 40, 346, 511));
        treeWidget_rviz->header()->setVisible(false);
        ...
        menuBar->setGeometry(QRect(0, 0, 459, 28));
