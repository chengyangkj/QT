...
QT_MOC_LITERAL(1, 23, 13), // "sigGetWidgets"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 12), // "valueChanged"
QT_MOC_LITERAL(4, 51, 5), // "value"
QT_MOC_LITERAL(5, 57, 17) // "animationFinished"

    },
    "AnimationStackedWidget\0sigGetWidgets\0"
    "\0valueChanged\0value\0animationFinished"
};
...
void AnimationStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigGetWidgets((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (AnimationStackedWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AnimationStackedWidget::sigGetWidgets)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AnimationStackedWidget::staticMetaObject = {
    { &QStackedWidget::staticMetaObject, qt_meta_stringdata_AnimationStackedWidget.data,
      qt_meta_data_AnimationStackedWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AnimationStackedWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AnimationStackedWidget.stringdata0))
        return static_cast<void*>(const_cast< AnimationStackedWidget*>(this));
...
// SIGNAL 0
void AnimationStackedWidget::sigGetWidgets(int _t1)
{
